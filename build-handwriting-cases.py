...
GUIDES = {
    14: [
        ...
        },
        {
            ...
            "note": "왜 자연수를 다시 보나요? m=−3은 그래프 조건이고, 마지막에는 자연수 a,b라는 문제 첫 줄을 숫자 조건에 적용해야 합니다. 세 후보를 모두 비교해야 최대 합 51을 확인할 수 있습니다.",
        },
    ],
    10: [
        {
    ...
    3: [
        ...
        },
        {
            ...
            "where": "필기장 가운데 위",
            "text": "길이만 보면 1/(2√2)=√2/4\n승주형 학생 시도: tan θ=+√2/4 → ⑤에 손이 가는 장면\n아직 확정하지 않고 잠깐 멈춥니다.",
            "note": "왜 이 줄을 남기나요? 승주형 원문에서는 학생이 삼각형 길이는 맞게 구했지만 사분면을 빼먹어 양수 ⑤를 고르려 합니다. 이는 정답이 아니라 영상에 보여줄 학생의 실수입니다. 이미 조건을 이해했다면 이 단계를 건너뛰고 바로 음수로 고쳐도 됩니다.",
        },
        {
            "title": "문제 첫 줄로 돌아가기",
        ...
        },
        {
            ...
            "note": "승주형 노션의 3번은 다섯 장면 모두 볼드입니다. 길이 계산, ⑤ 직전의 멈춤, 문제 첫 줄 확인, ②로 수정하는 흐름이 한 필기 기록에서 보이면 됩니다.",
        },
    ],
}
